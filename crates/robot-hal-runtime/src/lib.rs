...
use robot_hal_adapter_shared_memory::{FrameLease, MappingDescriptor};
...
use robot_hal_gpio::{GpioAdapter, GpioEdgeEvent, GpioEdgeRequest, GpioLineConfig};
use robot_hal_serial::{ControlLines, SerialAdapter, SerialConfig};
...
mod tests {
    ...
    use bytes::Bytes;
    use robot_hal_core::{HalResult, OwnerId, ResourceDescriptor, SessionId};
